...
class MakeCutouts(nn.Module):
    def __init__(self, cut_size, cutn, clip_view=None):
        ...
        augmentations.append(MyRandomPerspective(distortion_scale=0.2, p=0.7))
        augmentations.append(K.RandomResizedCrop(size=(self.cut_size,self.cut_size), scale=(0.1,0.8),  ratio=(0.8,1.2), cropping_mode='resample', p=0.7))
        augmentations.append(K.ColorJitter(hue=0.1, saturation=0.1, p=0.7))
        ...
        if global_aspect_width == 1:
            n_s = 0.95
            n_t = (1-n_s)/2
            augmentations.append(K.RandomAffine(degrees=0, translate=(n_t, n_t), scale=(n_s, n_s), p=1.0))
        elif global_aspect_width > 1:
            n_s = 1/global_aspect_width
            n_t = (1-n_s)/2
            augmentations.append(K.RandomAffine(degrees=0, translate=(0, n_t), scale=(0.9*n_s, n_s), p=1.0))
        else:
            n_s = global_aspect_width
            n_t = (1-n_s)/2
            augmentations.append(K.RandomAffine(degrees=0, translate=(n_t, 0), scale=(0.9*n_s, n_s), p=1.0))
        ...
        augmentations.append(K.RandomPerspective(distortion_scale=0.2, p=0.7))
        augmentations.append(K.ColorJitter(hue=0.1, saturation=0.1, p=0.7))
